...
export const handleFileDownload = (receivedData) => {
  ...
  try {
    ...
    notification.open({
      ...
      description: `${receivedData.fileName} (${(receivedData.file.byteLength / 1024).toFixed(2)} KB)`,
        ...
        <Button
          ...
          onClick={() => {
            try {
              ...
              const blob = new Blob(
                [receivedData.file instanceof ArrayBuffer ? receivedData.file : new Uint8Array(receivedData.file)],
