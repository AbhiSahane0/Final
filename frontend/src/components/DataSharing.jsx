...
const DataSharing = () => {
  ...
  useEffect(() => {
    ...
    const handleBeforeUnload = (event) => {
      // Only prevent closing if there's an active session
      if (peer.started) {
        const message =
          "⚠️ You have an active data sharing session. Please click the 'Stop' button to properly close your connection before leaving.";
